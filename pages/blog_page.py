...
class BlogPage(BasePage):
    ...
    def check_if_user_is_redirected_to_blog_section(self, blog_section_title):
        ...
        assert blog_section_title in section_title_upper_case, "\nRedirection to blog section page is not carried out"
    ...
    def check_if_user_is_redirected_to_blog_topic(self, blog_topic_title):
        ...
        assert blog_topic_title in topic_title_in_search_tree, "\nRedirection to blog topic page is not carried out"
